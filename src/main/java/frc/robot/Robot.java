...
private static int initCounter = 0;
  ...
  public void autonomousInit() {
    ...
    initCounter++;
    SmartDashboard.putNumber("While_Gyro_start", Robot.m_subsystem.getAngle());

    while(Math.abs(Robot.m_subsystem.getAngle()) > 5 ){
      SmartDashboard.putNumber("While_Gyro", Robot.m_subsystem.getAngle());
